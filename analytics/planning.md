...
The Planning module lets you set production goals for your company or individual loan officers and track progress against those targets in real time. Goals can target volume, units, or revenue over monthly, quarterly, or yearly periods.
...
> ![Screenshot: Planning overview with goal cards](screenshots/planning-overview.png)
...
> ![Screenshot: Create goal form](screenshots/create-goal.png)
...
> ![Screenshot: Goal progress cards](screenshots/goal-progress.png)
...
- **Volume goals** -- Sum of `loanAmount` for all funded loans in the period
- **Units goals** -- Count of funded loans in the period
- **Revenue goals** -- Sum of `brokerCompensation` for all funded loans in the period
...
Set a goal's `isActive` flag to control whether it appears in the progress dashboard. Deactivating a goal hides it from the main view without deleting it, which is useful for completed or paused goals.
