...
description: "Pipeline Analytics shows where active loans sit across processing stages, measures stage-to-stage velocity, and surfaces bottlenecks in real time."
---

## Overview

The pipeline dashboard focuses on **active loans** -- loans that have not yet reached a terminal status (Funded, Adverse, or post-funding statuses). It answers questions like:
...
![Pipeline analytics](/images/analytics/pipeline-analytics.png)
