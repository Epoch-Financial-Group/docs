...
description: "Pipeline Analytics provides a real-time view of your active loan pipeline, showing where loans sit across processing stages, identifying bottlenecks, measuring stage-to-stage velocity, and breaking..."
---
...
> <img alt="Screenshot: Pipeline analytics overview" src="screenshots/pipeline-overview.png" />
...
> <img alt="Screenshot: Pipeline stage breakdown" src="screenshots/pipeline-stages.png" />
...
> <img alt="Screenshot: Bottleneck loans table" src="screenshots/pipeline-bottlenecks.png" />
...
> <img alt="Screenshot: Pipeline velocity chart" src="screenshots/pipeline-velocity.png" />
...
> <img alt="Screenshot: Pipeline by loan officer" src="screenshots/pipeline-by-lo.png" />
