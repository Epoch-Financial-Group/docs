...
> ![Screenshot: Compensation Estimator section on the candidate detail page with inputs and results](screenshots/comp-estimator.png)
...
> ![Screenshot: Compensation Estimator results card showing rate, monthly gross, file fee, monthly net, and annual projection](screenshots/comp-estimator-results.png)
...
Only active templates appear in the estimator dropdown. See the [Commissions documentation](../commissions/README.md) for details on creating and managing commission templates.
