...
description: "Day-to-day candidate management: viewing the candidate list, filtering, editing candidate information, and logging interactions and next steps."
---

## Viewing candidates

Go to **Recruiting** in the sidebar. The page displays a paginated table of all candidates in your company.
...
Filters can be combined. For example, you can filter for all **Loan Officer** candidates in the **Interview** stage who were sourced from **LinkedIn**.
...
Clicking on a candidate's name in the table opens their detail page.
