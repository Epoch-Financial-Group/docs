---
title: "Onboarding"
description: "Onboarding is the process of converting an accepted candidate into a fully operational employee. Keystone provides a guided conversion workflow that creates the employee record, transfers data from..."
---
...
> <img alt="Screenshot: Convert to Employee button on the candidate detail page" src="screenshots/convert-candidate-button.png" />
...
> <img alt="Screenshot: Convert to Employee form showing pre-filled fields and role checkboxes" src="screenshots/convert-candidate-form.png" />
...
> <img alt="Screenshot: Onboarding dashboard showing new employees with progress bars for their onboarding checklists" src="screenshots/onboarding-dashboard.png" />
