---
title: "Super Admin"
description: "Super admin is the highest level of access in Keystone. While regular users operate within the context of a single company, super admins have platform-wide visibility and the ability to create and ..."
---
...
> <img alt="Screenshot: Admin dashboard showing platform statistics and recent companies table" src="screenshots/admin-dashboard.png" />

### Company management

From the admin panel, super admins can navigate to `/admin/companies` to manage all companies. See [Multi-Company Management](/administration/multi-company) for details.
