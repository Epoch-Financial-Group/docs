...
| Page | Description |
|------|-------------|
| [Super Admin](super-admin.md) | What super admin access is, how it is controlled, and what super admins can do |
| [Multi-Company Management](multi-company.md) | How multi-tenancy works, creating and managing companies, data isolation, and Stripe integration |
