...
description: "Keystone is built as a multi-tenant platform, meaning a single deployment can serve multiple independent companies. Each company has its own data, employees, loans, settings, and configurations. Th..."
---
...
> <img alt="Screenshot: Create Company form showing name, slug, NMLS, LOS dropdown, and email domains fields" src="screenshots/create-company.png" />
...
See [Company Setup](/administration/../company-setup/index) for detailed guidance on initial configuration.
...
> <img alt="Screenshot: Company list table in the admin panel showing company names, slugs, employee counts, and status" src="screenshots/company-list.png" />
...
> <img alt="Screenshot: Company detail page showing company info, employee roster, and counts" src="screenshots/company-detail.png" />
...
> <img alt="Screenshot: Admin dashboard showing total companies, active companies, and total employees cards" src="screenshots/admin-platform-stats.png" />
