...
description: "An overview of Keystone's policy management system, a built-in authoring and distribution tool that replaces shared drives and email attachments."
---

![Policy library](/images/policies/policies-list.png)
...
A policy is a single document with a title and rich-text body. Each policy has:
...
The policy library is accessible from the sidebar under **Policies**.
