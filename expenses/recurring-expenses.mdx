...
description: "Recurring expenses let you define costs that repeat on a schedule, so you do not have to manually enter the same expense every week or month. The system automatically generates individual expense r..."
---
...
> <img alt="Screenshot: Add recurring expense dialog" src="screenshots/add-recurring-expense.png" />
...
> <img alt="Screenshot: Recurring expenses table" src="screenshots/recurring-expenses-table.png" />
...
> <img alt="Screenshot: Edit recurring expense dialog" src="screenshots/edit-recurring-expense.png" />
