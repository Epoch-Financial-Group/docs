...
> **Screenshot placeholder:** *Pipeline table view showing loan rows with status badges and key columns.*

## Navigating to the pipeline

The pipeline lives at `/{company}/loans`. You can reach it from the sidebar navigation by clicking **Loans**.
...
> **Screenshot placeholder:** *Column visibility dropdown with checkboxes for each column.*
...
> **Screenshot placeholder:** *Search bar in the pipeline toolbar with an active search query.*
...
> **Screenshot placeholder:** *Filter panel open with Status, Loan Officer, and Lender dropdowns.*
...
The pipeline page header provides two action buttons:

- **Upload CSV** -- Navigate to the bulk upload page to import loans from a CSV file
- **Add Loan** -- Navigate to the loan creation form to add a single loan manually

## Clicking a loan row

Click anywhere on a loan row to navigate to that loan's detail page, where you can view and edit all loan information, manage the team, track revenue, and more.
