...
Loan adjustments let you add or subtract amounts from a loan's revenue and commission calculations. They handle scenarios like processing fee credits, lender concessions, one-off deductions, or overrides that do not fit neatly into the standard line item structure.
...
> **Screenshot placeholder:** *Adjustments section on the Revenue tab showing a list of adjustments with an Add Adjustment button.*
...
> **Screenshot placeholder:** *Add Adjustment dialog showing all fields filled in.*
