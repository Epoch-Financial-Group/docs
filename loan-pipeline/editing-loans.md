...
Once a loan is created, you can update any of its details from the loan detail page. The detail page is organized into tabs, each covering a different aspect of the loan.

## Getting to the loan detail page

- Click any loan row in the pipeline table, or
- Click the **Loan #** link in the pipeline, or
- Navigate directly to `/{company}/loans/{id}`
...
> **Screenshot placeholder:** *Loan detail page showing header, summary cards, and tabbed content.*
...
> **Screenshot placeholder:** *Overview tab in edit mode showing editable fields with Save/Cancel buttons.*
...
For a more traditional form experience, click the **Edit Loan** button in the page header. This navigates to `/{company}/loans/{id}/edit`, which shows the same form layout used when creating a loan, pre-populated with the current values.

> **Screenshot placeholder:** *Full edit form at /{company}/loans/{id}/edit.*
...
> **Screenshot placeholder:** *Revenue tab showing summary cards and line items table in edit mode.*
...
> **Screenshot placeholder:** *Dates tab showing date picker fields in two columns.*
