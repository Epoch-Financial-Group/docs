---
title: "Adding Loans"
description: "You can add a loan to Keystone either manually through the loan form or in bulk via CSV upload (see [Bulk Upload](/loan-pipeline/bulk-upload)). This page covers the manual creation process."
---

You can add a loan to Keystone either manually through the loan form or in bulk via CSV upload (see [Bulk Upload](/loan-pipeline/bulk-upload)). This page covers the manual creation process.
