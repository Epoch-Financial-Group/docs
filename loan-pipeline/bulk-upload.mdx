---
title: "Bulk Upload"
description: "Keystone supports importing loans in bulk via CSV file upload. This is the fastest way to onboard an existing pipeline, sync data from your Loan Origination System (LOS), or do periodic pipeline up..."
---
