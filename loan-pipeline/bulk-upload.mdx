---
title: "Bulk Upload"
description: "Import loans in bulk via CSV to onboard an existing pipeline, sync from your LOS, or do periodic pipeline updates without manual data entry."
---
...
| `Loan Type`, `Type`, `Product Type`, `Mortgage Type` | Loan Type | Conventional, FHA, VA, USDA, Non-QM, Non-QM, Reverse Mortgage, HELOC, Commercial, HELOAN |
...
| `Status`, `Loan Status`, `Milestone`, `Current Milestone` | Status | See [Loan Statuses](/loan-pipeline/loan-statuses); flexible matching |
