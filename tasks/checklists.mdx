---
title: "Checklists"
description: "Checklists are instances of task templates, created with individual tasks and due dates automatically calculated from a trigger date you specify."
---
...
1. Navigate to **Tasks > Checklists** in the sidebar and click **New Checklist**.
...
1. Go to **Tasks > Checklists**. The list shows all checklists with:
   - Checklist name
   - Associated template
