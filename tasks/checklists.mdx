---
title: "Checklists"
description: "Checklists are specific instances of task templates. When you instantiate a template, Keystone creates a checklist containing individual tasks for each template item, with due dates calculated from..."
---
