...
description: "This page covers how to create tasks, fill in their properties, break work into subtasks, and use comments for collaboration."
---
...
1. Open the task by clicking its row in the task table.
2. Click **Edit**.
3. Modify any fields.
