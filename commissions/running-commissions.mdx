---
title: "Running Commissions"
description: "Running commissions covers how to group funded loans into pay periods, calculate compensation, review results, and finalize each pay period."
---

![Run commissions pay period view](/images/commissions/run-commissions.png)
...
| Recipient Role | Loan Officer, Loan Officer Assistant, Processor, or Branch Manager |
