...
description: "A commission template defines the compensation structure for a specific employee role. Templates serve as blueprints -- once created, they are assigned to individual employees to generate the commi..."
---
