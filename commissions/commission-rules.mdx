...
description: "Commission rules override the base commission defined on a template when a loan matches specific criteria. Rules let you define different commission amounts for different loan scenarios -- for exam..."
---
