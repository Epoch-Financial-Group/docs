...
- **Account Mappings** tell EpochOS which accounts to debit and credit when specific loan events occur (funding, check receipt, commission payment, etc.).
...
- EpochOS uses **double-entry bookkeeping**: every transaction has equal debits and credits, ensuring the accounting equation (Assets = Liabilities + Equity) always holds.
