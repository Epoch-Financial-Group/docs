...
For an employee to log in to Keystone, their employee record must have an **email address** that matches the email they sign up with. Keystone links accounts automatically on first login.
