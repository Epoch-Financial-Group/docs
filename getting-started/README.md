...
| Page | Description |
|------|-------------|
| [First Login](first-login.md) | Creating your account, signing in, selecting your company, and understanding what you see on your first visit. |
| [Initial Setup](initial-setup.md) | A step-by-step walkthrough for company administrators covering company settings, branches, employees, lenders, lead sources, chart of accounts, and commission templates. |
| [Navigation](navigation.md) | A complete guide to the sidebar, collapsible navigation groups, company switching, and responsive behavior. |
