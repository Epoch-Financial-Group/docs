...
> ![Screenshot: Company general settings form](screenshots/company-settings-general.png)
...
> ![Screenshot: Payroll settings form](screenshots/company-settings-payroll.png)
...
> ![Screenshot: Create branch form](screenshots/create-branch.png)
...
| Email | No | Work email address. This email is used to link the employee to a Supabase Auth account for login. |
...
> ![Screenshot: Add employee form](screenshots/add-employee.png)
...
> ![Screenshot: People directory with filters](screenshots/people-directory.png)
...
> ![Screenshot: Add lender form](screenshots/add-lender.png)
...
> ![Screenshot: Lender detail page with contacts](screenshots/lender-contacts.png)
...
> ![Screenshot: Lead sources management](screenshots/lead-sources.png)
...
> ![Screenshot: Chart of accounts page](screenshots/chart-of-accounts.png)
...
> ![Screenshot: Commission template editor](screenshots/commission-template-editor.png)
...
> ![Screenshot: Commission template list](screenshots/commission-templates-list.png)
...
For a full guide to the application layout, see [Navigation](navigation.md).
