---
title: "Navigation"
description: "This guide explains how to navigate Keystone, covering the sidebar layout, every navigation item, the company switcher, responsive behavior, and how active pages are highlighted."
---
...
> <img alt="Screenshot: Full application layout with sidebar" src="screenshots/full-layout-sidebar.png" />
...
| Plan Templates | `/[company]/commission-templates` | Create and manage commission plan templates that define how employees are compensated. See [Initial Setup](/getting-started/initial-setup) for details. |
...
| Sub-item | Route | Description |
|----------|-------|-------------|
| Company Settings | `/[company]/settings` | Configure company name, NMLS number, LOS selection, payroll settings, and lead sources. See [Initial Setup](/getting-started/initial-setup). |
...
> <img alt="Screenshot: Active navigation state showing highlighted item" src="screenshots/nav-active-state.png" />
...
> <img alt="Screenshot: Sidebar with some groups expanded and some collapsed" src="screenshots/nav-groups-expanded-collapsed.png" />
...
> <img alt="Screenshot: Collapsed sidebar with tooltips" src="screenshots/nav-collapsed-sidebar.png" />
...
> <img alt="Screenshot: Company switcher page" src="screenshots/company-switcher.png" />
...
> <img alt="Screenshot: Mobile view with sidebar as overlay" src="screenshots/nav-mobile-responsive.png" />
