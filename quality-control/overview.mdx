---
title: "QC Overview"
description: "An overview of how QC works in Keystone, covering templates, reviews, and how the system supports your required loan audit program."
---

![Quality control overview](/images/quality-control/qc-overview.png)
...
See [QC Templates](/quality-control/qc-templates) for details on creating and managing templates.
...
See [QC Reviews](/quality-control/qc-reviews) for details on conducting and managing reviews.
...
Before running your first QC selection, configure your QC settings under **Administration > Company Settings > Quality Control**:
