...
> <img alt="Screenshot: QC Settings form showing selection percentage, eligible statuses, and auto-select toggle" src="screenshots/qc-settings.png" />
...
> <img alt="Screenshot: Default template seed button on the QC Settings page" src="screenshots/qc-seed-template.png" />
