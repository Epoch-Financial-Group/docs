---
title: "QC Reviews"
description: "A QC review audits a specific loan against a template checklist, tracking Pass/Fail/N/A results, reviewer notes, and an overall review status."
---

## QC review dashboard

Go to **Quality Control > QC Dashboard** in the sidebar. The dashboard displays a paginated table of all reviews with the following columns:
...
1. Go to the QC Dashboard and click **Run Selection** in the toolbar.
...
1. Open the loan detail page and click the **QC** tab.
...
Go to the QC Dashboard and click on a review row to open it.
...
Open the loan detail page and click the **QC** tab. If a review exists, you will see its status, summary counts, reviewer, and the full checklist with results. If no review exists, you will see an option to create one.

## QC selection history

The selection history is available in the filter panel on the QC Dashboard, showing each month with its loan count. This helps you verify that selections are being run consistently and that sample sizes meet your policy requirements.
