---
title: "Branches"
description: "Branches represent the physical locations or organizational units within your mortgage company. Every employee can be assigned to a branch, and branch-level groupings are used throughout Keystone f..."
---
...
> <img alt="Screenshot: Branch list page showing branch names and managers" src="screenshots/branch-list.png" />
...
> <img alt="Screenshot: Add Branch form with name and manager fields" src="screenshots/branch-add.png" />
