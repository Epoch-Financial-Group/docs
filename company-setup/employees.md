...
> ![Screenshot: Employee directory table with filters](screenshots/employee-directory.png)
...
> ![Screenshot: Employee filter bar with role and branch dropdowns](screenshots/employee-filters.png)
...
> ![Screenshot: Basic Information section of the employee form](screenshots/employee-form-basic.png)
...
> ![Screenshot: Employment section showing role checkboxes and branch dropdown](screenshots/employee-form-employment.png)
...
> ![Screenshot: Draw and Payroll section of employee form](screenshots/employee-form-draw.png)

{% hint style="info" %}
Company-wide draw defaults are configured in [Company Settings](company-settings.md). Individual employee settings override the company defaults.
{% endhint %}
...
> ![Screenshot: State licenses tab on employee detail page](screenshots/employee-licenses.png)
...
> ![Screenshot: Employee detail page showing the Info tab](screenshots/employee-detail.png)
...
- [Branches](branches.md) -- employees are assigned to branches
- [Company Settings](company-settings.md) -- company-wide draw and payroll defaults
- [Lenders](lenders.md) -- lenders are associated with loans, which are in turn tied to employees
- [Lead Sources](lead-sources.md) -- lead sources can be used in commission rules that reference employees
