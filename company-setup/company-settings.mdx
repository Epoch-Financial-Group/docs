...
description: "Company Settings is the central configuration page for your Keystone account. Here you define your company identity, select your Loan Origination System, enter your NMLS number, and configure payro..."
---
...
> <img alt="Screenshot: Administration section in sidebar with Company Settings highlighted" src="screenshots/company-settings-nav.png" />
...
> <img alt="Screenshot: Loan Origination System dropdown on Company Settings page" src="screenshots/los-selection.png" />
...
> <img alt="Screenshot: Payroll settings form with commission and draw configuration" src="screenshots/payroll-settings.png" />
